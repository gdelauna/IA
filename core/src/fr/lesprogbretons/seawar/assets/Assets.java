...
public class Assets {
    ...
    public static final AssetDescriptor<Texture> menu =
            new AssetDescriptor<>("./core/assets/menuShip.jpg", Texture.class, param);

    public static final AssetDescriptor<TextureAtlas> hexes =
                new AssetDescriptor<>("./core/assets/hexes.atlas", TextureAtlas.class);

    public static final AssetDescriptor<Texture> background =
            new AssetDescriptor<>("./core/assets/back.png", Texture.class, param);

    public static final AssetDescriptor<Skin> skin =
            new AssetDescriptor<>("./core/assets/skin/uiskin.json", Skin.class);

//    public static final AssetDescriptor<Music> menuMusic = new AssetDescriptor<>("music/musiquemenu.mp3", Music.class);
    public static final AssetDescriptor<Music> gameMusic = new AssetDescriptor<>("./core/assets/music/grandioso.mp3", Music.class);
